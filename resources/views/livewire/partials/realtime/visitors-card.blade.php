<div class="bg-gradient-to-r from-emerald-50/50 to-teal-50/50 dark:from-gray-800/50 dark:to-gray-700/50 rounded-xl border border-emerald-100 dark:border-gray-700 shadow-lg hover:shadow-[0_20px_60px_-15px_rgba(16,185,129,0.5)] transition-all duration-500 transform hover:-translate-y-2 hover:scale-[1.02]">
    <div class="p-8 relative overflow-hidden">
        ...
        <div class="flex items-center justify-between relative">
            <div class="space-y-4">
                <div class="flex items-center space-x-4">
                    <div class="relative group">
                        ...
                        <div class="relative flex items-center justify-center bg-white/10 dark:bg-gray-900/50 backdrop-blur-md rounded-2xl w-16 h-16 group-hover:scale-110 transition-all duration-500">
                            ...
                            <x-icon name="heroicon-o-users" class="w-8 h-8 text-white transform group-hover:rotate-12 transition-transform duration-500" />
                        </div>
                    </div>
                    <div class="flex items-center space-x-3">
                        <h3 class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400 animate-text-shimmer hover:scale-110 transition-transform duration-300">{{ __('VISITORS') }}</h3>
                        <div class="group relative flex-shrink-0">
                            <x-icon name="heroicon-o-information-circle" 
                                ...
                                x-data="{}"
                                x-tooltip.raw="{{ __('A visitor represents a page load of your website through direct access, or through a referrer.') }}" />
                            <div class="absolute hidden group-hover:block bg-white/95 dark:bg-gray-800/95 text-emerald-600 dark:text-emerald-400 text-sm rounded-xl py-3 px-4 -mt-2 mx-auto left-1/2 transform -translate-x-1/2 w-72 z-50 pointer-events-none border-2 border-emerald-400 dark:border-emerald-600 shadow-xl backdrop-blur-sm">
                                {{ __('A visitor represents a page load of your website through direct access, or through a referrer.') }}
                ...
                include('analytics::livewire.partials.growth', ['growthCurrent' => $totalVisitors, 'growthPrevious' => $visitorsOld, 'type' => 'visitors'])
            </div>
            <div class="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400 animate-text-shimmer tracking-tighter hover:scale-110 transition-transform duration-300" style="text-shadow: 4px 4px 8px rgba(16,185,129,0.5);" id="visitors-count">
