<div class="mb-10 mt-4">
    <div class="bg-gray-700 rounded-2xl shadow-lg border border-gray-600 hover:border-blue-500 transform hover:-translate-y-1 transition-all duration-300 p-6">
        ...
        <div class="flex flex-wrap justify-between items-center mt-4">
            ...
            <select id="chartTypeToggle" class="bg-gray-800 border border-gray-600 rounded py-2 px-4 text-gray-200">
            ...
            <div class="flex items-center">
                <span class="mr-2 text-gray-300">{{ __('Smoothing') }}:</span>
