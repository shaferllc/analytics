    ...
    <div class="container max-w-7xl m-auto">
        <div class="bg-white flex-grow">
            <a href="{{ route(name: 'analytics.sites.create') }}" class="btn btn-primary flex justify-center items-center mt-3 md:mt-0">
                        ...
                        <div class="w-full lg:w-auto">
                            <ul class="flex flex-wrap justify-center lg:justify-end space-x-2 text-sm">
                                ...
                                @foreach($dateRanges as $key => $dateRange)
                                    <li>
                                        <a href="{{ route('analytics.index', ['from' => $dateRange['from'], 'to' => $dateRange['to']]) }}" 
                                            ...
                                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 items-center">
                                                <div class="flex items-center truncate">
                                                    ...
                                                    <div class="truncate" dir="ltr">
                                                        <a href="{{ route('analytics.stats.overview', ['website' => $website, 'from' => $range['from'], 'to' => $range['to']]) }}" class="text-blue-600 hover:text-blue-800">{{ $website->domain }}</a>
                                                    </div>
                                                </div>
